...
export function AppLayout() {
  ...
  const isCajeroRecepcion = ['CAJERO', 'RECEPCION'].includes(membershipRole || '');
  ...
  const visibleNavItems = isCajeroRecepcion ? navItemsByRole.all : [...navItemsByRole.all, ...navItemsByRole.adminAndSede];
      ...
      `}>
        <div className="flex flex-col h-full bg-white border-r border-[var(--border-subtle)]">
          ...
          <nav className="flex-1 p-3 space-y-1 overflow-y-auto">
            ...
            {['ADMIN_EMPRESA', 'ADMIN_SEDE'].includes(membershipRole || '') && (
              <div className="pt-3 mt-3 border-t border-[var(--border-subtle)]">
